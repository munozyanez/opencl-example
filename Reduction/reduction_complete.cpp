...
void create_buffer(cl_context &context,float *data,float *v1,float *v2,cl_mem &data_buffer,cl_mem &sum_buffer,cl_mem &v1_buffer,cl_mem &v2_buffer,cl_int &err){
...
int main() {
   ...
   /* Create data buffer */
   create_buffer(context,data,v1,v2,data_buffer,sum_buffer,v1_buffer,v2_buffer,err);
